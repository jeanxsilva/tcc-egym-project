...
export class PhysicalAssesmentScreenComponent implements OnInit, IFormBase {
  public schedule: any;
  ...
  get studentCaracteristic() {
    return this.formEntity.get('studentCaracteristic');
  }
  ...
  public save() {
    if (this.formEntity.valid) {
      ...
      entity.studentCaracteristics = this.formEntity.get('studentCaracteristic').value;
