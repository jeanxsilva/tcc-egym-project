...
namespace eGYM.GraphQL
{
    ...
    public class ShiftBookQuery
    {
        #region ListShiftBook()
        ...
        [UseFiltering]
        [UseSorting]
        //[Authorize(Roles = new[] { "ShiftBook.R" })]
        //[UseDbContext(typeof(EGymDbContext))]
        public virtual IQueryable<ShiftBook> ListShiftBook(
            [Service] EGymDbContext dbContext)
        {
            return dbContext.Set<ShiftBook>();
        }
