...
namespace eGYM.GraphQL
{
    ...
    public class InvoiceDetailQuery
    {
        ...
        [UseFiltering]
        [UseSorting]
        //[Authorize(Roles = new[] { "InvoiceDetail.R" })]
        //[UseDbContext(typeof(EGymDbContext))]
        public virtual IQueryable<InvoiceDetail> ListInvoiceDetail(
            [Service] EGymDbContext dbContext)
        {
            return dbContext.Set<InvoiceDetail>();
        }
