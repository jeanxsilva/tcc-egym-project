...
namespace eGYM.GraphQL
{
    ...
    public class RequestStatusQuery
    {
        ...
        [UseFiltering]
        [UseSorting]
        //[Authorize(Roles = new[] { "RequestStatus.R" })]
        //[UseDbContext(typeof(EGymDbContext))]
        public virtual IQueryable<RequestStatus> ListRequestStatus(
            [Service] EGymDbContext dbContext)
        {
            return dbContext.Set<RequestStatus>();
        }
